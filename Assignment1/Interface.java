...
public class Interface {
    ...
    private int logicalSize = 2;              //logicalSize is a int used to count the number of playlists we have
    ...
    private void processUserInput()
    {
        ...
        {                           //get the right answer
                    ...
                    }else if(answer.startsWith("new_playlist ")) //new_playlist command
                    {
                        ...
                        if (logicalSize >= 0 && logicalSize < 2)
                        {
                            //indexOf(int ch, int fromIndex)
                            S1 = answer.indexOf(' ');
                            S2 = answer.indexOf(',', S1+1);
                            ...
                            tempMovieIndex3 = database.getMovieNumber(tempMovie3);
                                ...
                                logicalSize++; //we're 0 indexed for our movies 0-4. 
